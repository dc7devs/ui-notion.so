export default class RandomList {
    ...
    TamplatesRandomList() {
        return [
            {
                src: "assets\images\random_hero\Hero_1.png"
            },
            {
                src: "assets\images\random_hero\Hero_2.png"
            },
            {
                src: "assets\images\random_hero\Hero_3.png"
            },
            {
                src: "assets\images\random_hero\Hero_4.png"
            },
            {
                src: "assets\images\random_hero\Hero_5.png"
            },
            {
                src: "assets\images\random_hero\Hero_6.png"
            },
            {
                src: "assets\images\random_hero\Hero_7.png"
            }
        ];
    }
}